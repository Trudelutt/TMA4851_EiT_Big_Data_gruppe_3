...
plot_country_development(data_dic,country_array,file_name,"total KCAL per innbygger",1,year_0)

file_name = "image/kcal_error_bar.eps"
plot_global_error_bar(data_dic,file_name,"total KCAL per innbygger",0,year_0)

years = list(range(25))
file_name = "image/kcal_varr.png"
plot_varity_country(data_dic, "total KCAL per innbygger per år",target_names, file_name,years)
year = [0,5,10,15,14,24]

file_name = "image/kcal_global.eps"
plot_global_development(data_dic,file_name,"total KCAL per innbygger",year_0)
